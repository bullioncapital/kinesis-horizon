...
func (s *EffectsProcessorTestSuiteLedger) SetupTest() {
	...
	s.firstTx = BuildLedgerTransaction(
		...
		TestTransaction{
			Index:         1,
			EnvelopeXDR:   "AAAAAgAAAAChl+0U/eniJ9tObqFB2J6i27dnD0TTka2hKHkwHK0SlAAAAAAAAABkAAAAOQAAAAEAAAABAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAABAAAAAAAAAAsAAABF2WS4AAAAAAAAAAAA",
			...
			Hash:          "1784e60b4c63ae0411f5e7ca857f678d5c5254d87eee16f2b50e9264c3f3ae50",
		},
	)
	...
	s.failedTx = BuildLedgerTransaction(
		...
		TestTransaction{
			Index:         4,
			EnvelopeXDR:   "",
...
func TestOperationEffects(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			envelopeXDR:   "",
		...
		},
		{
			...
			envelopeXDR:   "",
		...
		},
		{
			...
			envelopeXDR:   "",
		...
		},
		{
			...
			envelopeXDR:   "",
		...
		{
			desc:          "setOption",
			envelopeXDR:   "",
		...
		},
		{
			...
			envelopeXDR:   "",
		...
		},
		{
			...
			envelopeXDR:   "",
			resultXDR:     "AAAAAAAAAGQAAAAAAAAAAQAAAAAAAAAGAAAAAAAAAAA=",
		...
		},
		{
			...
			envelopeXDR:   "AAAAALly/iTceP/82O3aZAmd8hyqUjYAANfc5RfN0/iibCtTAAAAAAAAAGQACBh6AAAACgAAAAEAAAAAAAAAAAAAAABeF2jCAAAAAAAAAAEAAAAAAAAACgAAAAVoZWxsbwAAAAAAAAAAAAAAAAAAAaJsK1MAAABA8rtxyPW3ZMzQbOFIE41ZmLdy0NAgv+mvMlgZs/DoinmP0SfcCb1ff5tCVhrRVmzzl1gYPz497bYCjIh4fUyqBQ==",
			resultXDR:     "AAAAAAAAAGQAAAAAAAAAAQAAAAAAAAAKAAAAAAAAAAA=",
		...
		},
		{
			...
			envelopeXDR:   "",
			resultXDR:     "AAAAAAAAAGQAAAAAAAAAAQAAAAAAAAAKAAAAAAAAAAA=",
		...
		},
		{
			...
			envelopeXDR:   "AAAAAKGX7RT96eIn205uoUHYnqLbt2cPRNORraEoeTAcrRKUAAAAAAAAAGQAAABF2WS4AgAAAAAAAAAAAAAAAQAAAAAAAAALAAAARdlkuAEAAAAAAAAAARytEpQAAABAuB+0w57TlFwzIODH6Aj5Wy0UGR+1cDaVBzL7Z0VqliImP6p2GLtG74GFFbaBTjnqhJUSi2KrTltxc/YipdFkCQ==",
			resultXDR:     "AAAAAAAAAGQAAAAAAAAAAQAAAAAAAAALAAAAAAAAAAA=",
		...
		},
		{
			...
			envelopeXDR:   "AAAAAKGX7RT96eIn205uoUHYnqLbt2cPRNORraEoeTAcrRKUAAAAAAAAAGQAAAA5AAAAAQAAAAAAAAAAAAAAAQAAAAAAAAALAAAARdlkuAAAAAAAAAAAARytEpQAAABA6tCVYSjSKvWoNLEfkf3L93fbRLmmBJtgWsyMyC0XRo/WpWlTGQYcaCd2SKT9662gic8qCmTvqeRwVXtdGtvlBg==",
			resultXDR:     "AAAAAAAAAGQAAAAAAAAAAQAAAAAAAAALAAAAAAAAAAA=",
			metaXDR:       "",
			feeChangesXDR: "",
